	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-[.3s,.3s,.3s] ease-in-out md:flex",
					side === "left"
	...
	return (
		<main
			...
			className={cn(
				...
				"md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:my-2 md:peer-data-[variant=inset]:mr-2 md:peer-data-[variant=inset]:rounded-[4px] md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-processzen-border",
				className,
			)}
			{...props}
		/>
