...
export interface DataTableFiltersOptions<
	TData,
	TColumns extends ReadonlyArray<
		// biome-ignore lint/suspicious/noExplicitAny: TData is contravariant (accessor fn param), unknown breaks subtype checks
		ColumnConfig<TData, ColumnDataType, any, string>
	>,
